...
namespace lx
{
	// TODO v0.3 ListView - maybe even modify StringView to become a generic View. At the very least, define generic View for List and Matches
	// TODO v0.3 negative indexes - even in StringView
	...
	Variable List::data_member(VarContext& ctx, const std::string_view member)
	{
